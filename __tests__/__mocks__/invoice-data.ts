...
export const mockInvoiceData: Array<Invoice> = [
	...
	},
	{
		...
		Id: '60',
		SyncToken: '0',
		MetaData: { CreateTime: '2025-01-08T15:18:18-08:00', LastUpdatedTime: '2025-01-08T15:18:18-08:00' },
		CustomField: [],
		DocNumber: '1016',
		TxnDate: '2024-11-22',
		CurrencyRef: { value: 'USD', name: 'United States Dollar' },
		...
		Line: [
			{
				...
				Amount: 75,
				DetailType: 'SalesItemLineDetail',
				SalesItemLineDetail: { ItemRef: { value: '6', name: 'Gardening' }, UnitPrice: 25, Qty: 3, TaxCodeRef: { value: 'NON' } },
			},
			{ Amount: 75, DetailType: 'SubTotalLineDetail', SubTotalLineDetail: {} },
		],
		TxnTaxDetail: { TotalTax: 0 },
		CustomerRef: { value: '16', name: 'Kookies by Kathy' },
		CustomerMemo: { value: 'Thank you for your business and have a great day!' },
		BillAddr: {
			Id: '69',
			Line1: 'Kathy Kuplis',
			Line2: 'Kookies by Kathy',
			Line3: '789 Sugar Lane',
			Line4: 'Middlefield, CA  94303',
			Lat: '37.4530553',
			Long: '-122.1178261',
		},
	...
	},
	{
		...
		Id: '49',
		SyncToken: '0',
		MetaData: { CreateTime: '2025-01-08T11:43:20-08:00', LastUpdatedTime: '2025-01-08T11:43:20-08:00' },
		CustomField: [],
		DocNumber: '1015',
		TxnDate: '2025-01-08',
		CurrencyRef: { value: 'USD', name: 'United States Dollar' },
		LinkedTxn: [{ TxnId: '48', TxnType: 'Estimate' }],
		Line: [
			{
				Id: '1',
				LineNum: 1,
				...
				LinkedTxn: [{ TxnId: '48', TxnType: 'Estimate' }],
				DetailType: 'SalesItemLineDetail',
				SalesItemLineDetail: { ItemRef: { value: '4', name: 'Design' }, UnitPrice: 75, Qty: 4, TaxCodeRef: { value: 'NON' } },
			},
			{
				Id: '2',
				LineNum: 2,
				...
				LinkedTxn: [{ TxnId: '48', TxnType: 'Estimate' }],
				DetailType: 'SalesItemLineDetail',
				SalesItemLineDetail: { ItemRef: { value: '7', name: 'Installation' }, UnitPrice: 50, Qty: 5, TaxCodeRef: { value: 'NON' } },
			},
			{
				Id: '3',
				LineNum: 3,
				...
				LinkedTxn: [{ TxnId: '48', TxnType: 'Estimate' }],
				DetailType: 'SalesItemLineDetail',
				SalesItemLineDetail: { ItemRef: { value: '5', name: 'Rock Fountain' }, UnitPrice: 275, Qty: 1, TaxCodeRef: { value: 'NON' } },
			},
			{
				Id: '4',
				LineNum: 4,
				...
				LinkedTxn: [{ TxnId: '48', TxnType: 'Estimate' }],
				DetailType: 'SalesItemLineDetail',
				SalesItemLineDetail: { ItemRef: { value: '13', name: 'Rocks' }, UnitPrice: 22.5, Qty: 8, TaxCodeRef: { value: 'NON' } },
			},
			{ Amount: 1005, DetailType: 'SubTotalLineDetail', SubTotalLineDetail: {} },
			{
				Amount: 50.25,
				DetailType: 'DiscountLineDetail',
				DiscountLineDetail: { PercentBased: true, DiscountPercent: 5, DiscountAccountRef: { value: '86', name: 'Discounts given' } },
			},
		],
		TxnTaxDetail: { TotalTax: 0 },
		CustomerRef: { value: '18', name: 'Paulsen Medical Supplies' },
		CustomerMemo: { value: 'Thank you for your business and have a great day!' },
		BillAddr: {
			Id: '68',
			Line1: 'Kathy Paulsen',
		...
		PrintStatus: 'NotSet',
		EmailStatus: 'NotSet',
		BillEmail: { Address: 'Medical@intuit.com' },
		Balance: 954.75,
	},
	{
		AllowIPNPayment: false,
		...
		Id: '27',
		SyncToken: '1',
		MetaData: { CreateTime: '2025-01-07T15:38:07-08:00', LastUpdatedTime: '2025-01-08T11:17:33-08:00' },
		CustomField: [],
		DocNumber: '1009',
		TxnDate: '2025-01-07',
		CurrencyRef: { value: 'USD', name: 'United States Dollar' },
		LinkedTxn: [
			{ TxnId: '26', TxnType: 'ReimburseCharge' },
			{ TxnId: '40', TxnType: 'Payment' },
		],
		Line: [
			{
				Id: '1',
				...
				Amount: 103.55,
				DetailType: 'SalesItemLineDetail',
				SalesItemLineDetail: { ServiceDate: '2025-01-07', ItemRef: { value: '1', name: 'Services' }, TaxCodeRef: { value: 'NON' } },
			},
			{ Amount: 103.55, DetailType: 'SubTotalLineDetail', SubTotalLineDetail: {} },
		],
		TxnTaxDetail: { TotalTax: 0 },
		CustomerRef: { value: '26', name: 'Travis Waldron' },
		CustomerMemo: { value: 'Thank you for your business and have a great day!' },
	...
	},
	{
		...
		Id: '39',
		SyncToken: '0',
		MetaData: { CreateTime: '2025-01-08T11:16:52-08:00', LastUpdatedTime: '2025-01-08T11:16:52-08:00' },
		CustomField: [],
		DocNumber: '1012',
		TxnDate: '2024-12-27',
		CurrencyRef: { value: 'USD', name: 'United States Dollar' },
		...
		Line: [
			{
				...
				Amount: 30,
				DetailType: 'SalesItemLineDetail',
				SalesItemLineDetail: { ItemRef: { value: '16', name: 'Sprinkler Heads' }, UnitPrice: 2, Qty: 15, TaxCodeRef: { value: 'NON' } },
			},
			{
				Id: '2',
				LineNum: 2,
			...
			{ Amount: 305, DetailType: 'SubTotalLineDetail', SubTotalLineDetail: {} },
			{
				Amount: 30.5,
				DetailType: 'DiscountLineDetail',
				DiscountLineDetail: { PercentBased: true, DiscountPercent: 10, DiscountAccountRef: { value: '86', name: 'Discounts given' } },
			},
		],
		TxnTaxDetail: { TotalTax: 0 },
		CustomerRef: { value: '23', name: 'Barnett Design' },
		CustomerMemo: { value: 'Thank you for your business and have a great day!' },
		BillAddr: {
			Id: '58',
			Line1: 'Shara Barnett',
		...
		PrintStatus: 'NeedToPrint',
		EmailStatus: 'NeedToSend',
		BillEmail: { Address: 'Design@intuit.com' },
		Balance: 274.5,
		DeliveryInfo: { DeliveryType: 'Email' },
	},
	{
		...
		Id: '34',
		SyncToken: '0',
		MetaData: { CreateTime: '2025-01-08T11:09:08-08:00', LastUpdatedTime: '2025-01-08T11:09:08-08:00' },
		CustomField: [],
		DocNumber: '1010',
		TxnDate: '2025-01-08',
		CurrencyRef: { value: 'USD', name: 'United States Dollar' },
		...
		Line: [
			{
				...
				Amount: 375,
				DetailType: 'SalesItemLineDetail',
				SalesItemLineDetail: { ItemRef: { value: '4', name: 'Design' }, UnitPrice: 75, Qty: 5, TaxCodeRef: { value: 'NON' } },
			},
			{ Amount: 375, DetailType: 'SubTotalLineDetail', SubTotalLineDetail: {} },
		],
		TxnTaxDetail: { TotalTax: 0 },
		CustomerRef: { value: '29', name: 'Weiskopf Consulting' },
		CustomerMemo: { value: 'Thank you for your business and have a great day!' },
		BillAddr: {
			Id: '56',
		...
		PrintStatus: 'NotSet',
		EmailStatus: 'NeedToSend',
		BillEmail: { Address: 'Consulting@intuit.com' },
		Balance: 375,
		DeliveryInfo: { DeliveryType: 'Email' },
	},
	{
		...
		Id: '16',
		SyncToken: '1',
		MetaData: { CreateTime: '2025-01-07T15:10:40-08:00', LastUpdatedTime: '2025-01-08T11:06:49-08:00' },
		CustomField: [],
		DocNumber: '1007',
		TxnDate: '2024-12-16',
		CurrencyRef: { value: 'USD', name: 'United States Dollar' },
		LinkedTxn: [{ TxnId: '32', TxnType: 'Payment' }],
		Line: [
			{
				Id: '1',
				LineNum: 1,
				...
				Amount: 750,
				DetailType: 'SalesItemLineDetail',
				SalesItemLineDetail: { ItemRef: { value: '4', name: 'Design' }, UnitPrice: 75, Qty: 10, TaxCodeRef: { value: 'NON' } },
			},
			{ Amount: 750, DetailType: 'SubTotalLineDetail', SubTotalLineDetail: {} },
		],
		TxnTaxDetail: { TotalTax: 0 },
